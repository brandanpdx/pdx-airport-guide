...
export class Map {
  ...
  async getRestuarantsInfo() {
    try {
      let response = await fetch (`https://maps.googleapis.com/maps/api/place/textsearch/json?query=restaurant,food&location=45.5891,-122.5934&key=${process.env.GOOGLE_PLACE_API_KEY}`);
